...
public class ProducerConfig {
     ...
     */
    private static final int RECORDS_PER_SECOND_DEFAULT = 150;

    //Set stream name
    public static final String STREAM_NAME_DEFAULT = "robdemo-connect-cdrs";
